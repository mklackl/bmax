...
> **Deprecated:** Use `bmax run` instead, which starts Ralph and shows the live dashboard. The `watch` command will be removed in a future release.

Launch the bmax live dashboard to monitor Ralph loop progress in real-time.
