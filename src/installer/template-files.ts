...
# Generated by: bmax init
# Documentation: https://github.com/LarsCowe/bmax
#
...
# Review mode: off, enhanced, or ultimate (set via 'bmax run --review [mode]')
...
# Enable periodic code review loops (set via 'bmax run --review' or manually)
